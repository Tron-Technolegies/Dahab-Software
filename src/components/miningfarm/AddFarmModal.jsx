...
import { useAddMiningFarm } from "../../hooks/miningfarm/useMiningFarm";
...
export default function AddFarmModal({ open, handleClose }) {
  ...
  const { isPending, mutateAsync } = useAddMiningFarm();
